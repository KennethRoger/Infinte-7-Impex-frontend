...
import { BookOpen, Plus, RefreshCw, FileText, ListOrdered } from 'lucide-react';
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-xl p-6 border border-[#E5DCD1] shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="space-y-1">
          ...
          <p className="text-xs sm:text-sm text-slate-600">
            Author and publish market intelligence articles with structured sections, titles, and descriptions.
          </p>
        </div>
      ...
      <div className="bg-white rounded-xl border border-[#E5DCD1] p-8 sm:p-12 text-center space-y-4 shadow-sm">
        ...
        <div className="space-y-1 max-w-md mx-auto">
          <h3 className="text-base font-bold text-[#1A221E]">Blog Section Ready</h3>
          <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
            This section will enable admins to create and edit export blog posts adhering to the BlogSchema, adding multiple sections with dynamic sectionTitle and description pairs.
          </p>
        </div>
        <div className="flex items-center justify-center gap-6 text-xs text-slate-500 pt-2">
          <span className="flex items-center gap-1.5">
            <ListOrdered className="w-3.5 h-3.5 text-[#7C3AED]" /> Multi-Section Builder
          </span>
          <span className="flex items-center gap-1.5">
            <FileText className="w-3.5 h-3.5 text-[#C88A2C]" /> Editorial Formatting
          </span>
        </div>
      </div>
    </div>
