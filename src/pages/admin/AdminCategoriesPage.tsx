    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-xl p-6 border border-[#E5DCD1] shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="space-y-1">
          ...
          <p className="text-xs sm:text-sm text-slate-600">
            Create and organize export product categories (e.g., Fresh Vegetables, Condiments, Packed Food).
          </p>
        </div>
      ...
      <div className="bg-white rounded-xl border border-[#E5DCD1] p-8 sm:p-12 text-center space-y-4 shadow-sm">
        ...
        <div className="space-y-1 max-w-md mx-auto">
          <h3 className="text-base font-bold text-[#1A221E]">Product Category Section Ready</h3>
          <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
            This section will allow admins to create new produce categories, upload category banner images, edit category slugs, and manage ordering.
          </p>
        </div>
        <div className="flex items-center justify-center gap-6 text-xs text-slate-500 pt-2">
          <span className="flex items-center gap-1.5">
            <Layers className="w-3.5 h-3.5 text-[#C88A2C]" /> Sub-category groupings
          </span>
          <span className="flex items-center gap-1.5">
            <Plus className="w-3.5 h-3.5 text-[#22C55E]" /> Easy category creation
          </span>
        </div>
      </div>
    </div>
